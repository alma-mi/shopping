...
class ShoppingGUI(wx.Frame):
    ...
    def show_login_screen(self):
        ...
        subtitle = wx.StaticText(
            self.main_panel,
            label="Login to search for products")
        ...
        self.password_entry = wx.TextCtrl(self.main_panel, size=(
    ...
    def show_shopping_screen(self):
        ...
        self.image_path_label = wx.StaticText(
            search_panel, label="No image selected")
    ...
    def on_image_search(self, event):
        ...
        loading = wx.StaticText(
            self.results_panel,
            label="Analyzing image and searching...")
        loading_font = wx.Font(
            12,
            wx.FONTFAMILY_DEFAULT,
            wx.FONTSTYLE_NORMAL,
            wx.FONTWEIGHT_NORMAL)
