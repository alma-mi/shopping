...
class CreateUserDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        super(CreateUserDialog, self).__init__(parent, title="Create New User", size=(450, 320))
        ...
        self.password_entry = wx.TextCtrl(self, size=(400, 30), style=wx.TE_PASSWORD)
        ...
        self.confirm_entry = wx.TextCtrl(self, size=(400, 30), style=wx.TE_PASSWORD)
